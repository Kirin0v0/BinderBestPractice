...
import com.soulkun.binderbestpractice.app1.databinding.ActivityInterapplicationBinding;

import java.util.Random;

public class InterapplicationActivity extends AppCompatActivity {

    private static final String TAG = "客户端";

    private IAidlInterface mAidlInterfaceImpl;

    private ActivityInterapplicationBinding mInterprocessBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInterprocessBinding = ActivityInterapplicationBinding.inflate(getLayoutInflater());
    ...
    protected void onStart() {
        ...
        intent.setComponent(new ComponentName("com.soulkun.binderbestpractice.app2", "com.soulkun.binderbestpractice.app2.InterapplicationService"));
